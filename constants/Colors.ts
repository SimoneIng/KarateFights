...
interface ThemeColors {
  ...
  const darkTheme:ThemeColors = {
    background: "#00171f", // Sfondo tema chiaro
    primary: "#3D5A80",    // Colore primario
    secondary: "#98C1D9",  // Colore secondario
    accent: "#0B1B2D",     // Colore di accento
    textPrimary: "#fff", // Testo principale
    textSecondary: "#e7ecef", // Testo secondario
    cardBackground: "#4895ef", // Sfondo delle card o superfici secondarie
    error: "#EE6C4D",       // Colore per errori
    border: "#d9d9d9",      // Colore dei bordi
  };
